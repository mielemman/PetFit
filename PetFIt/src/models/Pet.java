...
public abstract class Pet {
    ...
    // Pet actions
    public void feed() {
        setHunger(hunger + 20); // Ensure hunger does not exceed 100
        System.out.println(name + " has been fed and feels more full!");
    }

    public void play() {
        setHappiness(happiness + 15); // Ensure happiness does not exceed 100
    ...
    // Get valid input with range validation
